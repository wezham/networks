...
for index,letter in enumerate(list(string.ascii_uppercase)[:6]):
    print(f'osascript -e \'tell application "Terminal" to do script "python3 /Users/wesleyhamburger/Desktop/3331/assignment/networks/Lsr.py {letter} 500{index} /Users/wesleyhamburger/Desktop/3331/assignment/networks/test1/config{letter}.txt > test1.txt"\'')
